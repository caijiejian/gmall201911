...
public class CatalogController {
    ...
    public List<PmsBaseCatalog1> getCatalog1(){
        List<PmsBaseCatalog1> catalog1s = catalogService.getPmsCatalog1();
        return catalog1s;
    }
    ...
    public List<PmsBaseCatalog2> getCatalog2(String catalog1Id){
        List<PmsBaseCatalog2> catalog2s = catalogService.getPmsCatalog2(catalog1Id);
        return catalog2s;
    }
    ...
    public List<PmsBaseCatalog3> getCatalog3(String catalog2Id){
        List<PmsBaseCatalog3> catalog3s = catalogService.getPmsCatalog3(catalog2Id);
        return catalog3s;
    }
}
